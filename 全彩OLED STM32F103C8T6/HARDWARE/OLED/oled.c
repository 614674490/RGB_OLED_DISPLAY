...
{
	ssd1331_display_Chinese(16*0,0,0,MediumOrchid);
	ssd1331_display_Chinese(16*1,0,1,MediumOrchid);
	ssd1331_display_Chinese(16*2,0,2,MediumOrchid);
	ssd1331_display_Chinese(16*3,0,3,MediumOrchid);
	ssd1331_display_Chinese(16*4,0,4,MediumOrchid);
	ssd1331_display_Chinese(16*5,0,5,MediumOrchid);
	...
	ssd1331_display_string(9, 48, (uint8_t *)("2019-11-13"), FONT_1608, Green,DisOverlay_Display);
}
/**
 *	上色
 *	再次输入第三个色无效
